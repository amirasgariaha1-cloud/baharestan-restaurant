...
$stmt = $conn->prepare("INSERT INTO orders (user_id, total_price, status, payment_method, created_at, customer_name, customer_phone, customer_address) VALUES (?, ?, ?, ?, NOW(), ?, ?, ?)");
$user_id = $_SESSION['user_id'] ?? null;
$status = 'pending';
$stmt->bind_param("idsssss", $user_id, $total_price, $status, $payment_method, $customer_name, $customer_phone, $customer_address);
$stmt->execute();
